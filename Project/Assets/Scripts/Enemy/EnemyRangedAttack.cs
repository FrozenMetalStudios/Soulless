...
public class EnemyRangedAttack : MonoBehaviour
{
    ...
    void Start () {
        ARKLogger.LogMessage(eLogCategory.General, eLogLevel.Info, "initalizing ranged enemy");
	...
	void Update () {
        ...
        {
            ARKLogger.LogMessage(eLogCategory.General, eLogLevel.Trace, "enemy attacking player");
            //attack.
            Shoot();
        }
