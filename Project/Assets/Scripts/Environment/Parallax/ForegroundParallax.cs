...
{
    public class ForegroundParallax : ParallaxController
    {
        [Range(0, ParallaxController.MAX_FOREGROUND)]
        public int forefrontLevel = 0;               // Specifies the layer depth
        ...
        override public void PerformParallax(float cameraTravel)
        {
            ...
            float positionOffset = cameraTravel * (1 + (this.forefrontLevel * ((float)1 / ParallaxController.MAX_FOREGROUND)));
